...
class Matrimonio extends Model
{
     ...
     * @var array
     */
    protected $fillable = ['matFechaRegistro','matRegistroEclesiastico','matRegistroCivil','matEsposoId','matEsposaId','matPadrinoId','matMadrinaId','matParrocoId'];
